...
export const CartPage = () => {
  ...
  const handlePurchease = ()=> {
    const productsPurcheased = shoppingList.map(product => `${product.title} x ${product.quantity}`).join('\n')
    Swal.fire({
      icon: 'success',
      title: 'La compra se ha realizado con exito',
      html: `<p> Has comprado: </p> <pre>${productsPurcheased}</pre>`
    }) 
  }
